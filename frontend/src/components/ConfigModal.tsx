...
import { AdvancedTab } from './config-modal/AdvancedStrategyTab';
import { PartialFillsTab } from './config-modal/PartialFillsTab';
      ...
      >
        ...
        >
          ...
          <div className="flex-1 overflow-auto px-6 py-5 space-y-5">
            ...
            {activeTab === 'partial' && (
              <PartialFillsTab ticker={ticker} send={send} />
            )}
            {activeTab === 'risk' && (
